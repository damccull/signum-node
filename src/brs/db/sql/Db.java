...
// TODO: Remove this suppression after creating javadoc
...
public final class Db {
    ...
    public static void init(
        ...
        try {
            ...
            logger.info(
                    "Using SQL Backend with Dialect {} - Version {}",
                    databaseInstance.getDialect().getName(),
                    getDatabaseVersion());
            ...
            flyway = Flyway.configure()
                    ...
                    .locations(
                            databaseInstance.getMigrationClassPath(),
                            databaseInstance.getMigrationSqlScriptPath())
                    .load();
    ...
    // FIX: This needs to be investigated for safety
    ...
    static <V> Map<SignumKey, V> getCache(String tableName) {
        ...
        return (Map<SignumKey, V>) transactionCaches
                .get()
    ...
    static <V> Map<SignumKey, V> getBatch(String tableName) {
        ...
        // noinspection unchecked
        return (Map<SignumKey, V>) transactionBatches
                .get()
                .computeIfAbsent(tableName, k -> new HashMap<>());
    }
